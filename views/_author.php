...
<address class="post-author">
  ...
  <div class="author-bio">
    ...
    <?php echo H::markdown(get_the_author_meta( 'description' )); ?>
  </div>
  ...
  <div class="author-links">
    ...
    <?php if (isset($tsf['facebook_page'])): ?>
      <a href="<?php echo $tsf['facebook_page']; ?>" target="_blank">
    ...
    <?php if (isset($tsf['twitter_page'])): ?>
      <a href="https://twitter.com/<?php echo str_replace('@', '', $tsf['twitter_page']); ?>" target="_blank">
        <svg width="20px" height="20px" viewBox="0 0 20 20">
